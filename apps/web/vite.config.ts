...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      // Specific alias first so '@gaskya/ui/styles.css' wins before the bare '@gaskya/ui' rule.
      {
        find: '@gaskya/ui/styles.css',
        replacement: path.resolve(__dirname, '../../packages/ui/src/styles.css'),
      },
      { find: /^@gaskya\/ui$/, replacement: path.resolve(__dirname, '../../packages/ui/src/index.ts') },
      {
        find: /^@gaskya\/core$/,
