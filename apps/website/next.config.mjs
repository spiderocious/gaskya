...
const nextConfig = {
  ...
  transpilePackages: ['@gaskya/ui', '@gaskya/core'],
  webpack: (config) => {
    config.resolve.alias = {
      ...(config.resolve.alias ?? {}),
      '@gaskya/ui': path.resolve(__dirname, '../../packages/ui/src/index.ts'),
      '@gaskya/core': path.resolve(__dirname, '../../packages/core/src/index.ts'),
